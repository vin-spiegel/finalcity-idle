...
const LOOT_POOL: LogEntry[] = [
  {
    time: "",
    segments: [
      { type: "highlight", text: "마나 결정(중급)" },
      { type: "plain",     text: " ×2 획득 — " },
      { type: "reward",    text: "+120 BSS 상당" },
    ],
  },
  {
    time: "",
    segments: [
      { type: "plain",   text: "폐허 탐색 중 " },
      { type: "danger",  text: "변이체(2단계) 조우" },
      { type: "plain",   text: " — 자동 회피 성공" },
    ],
  },
  {
    time: "",
    segments: [
      { type: "highlight", text: "고대 유물 파편" },
      { type: "plain",     text: " 발견 — 유물 복원 스킬 적용 중" },
    ],
  },
  {
    time: "",
    segments: [
      { type: "plain", text: "폐허 탐색 " },
      { type: "good",  text: "Lv.12 달성" },
      { type: "plain", text: " — 탐색 속도 +5%" },
    ],
  },
  {
    time: "",
    segments: [
      { type: "plain",     text: "마나 결정(기본) ×3 획득 — " },
      { type: "reward",    text: "+45 BSS 상당" },
    ],
  },
  {
    time: "",
    segments: [
      { type: "highlight", text: "잠긴 금고" },
      { type: "plain",     text: " 발견 — 해제 시도 중" },
    ],
  },
  {
    time: "",
    segments: [
      { type: "plain",  text: "구역 탐색 중 " },
      { type: "danger", text: "마나 결정 폭발" },
      { type: "plain",  text: " 위험 감지 — 우회 경로 선택" },
    ],
  },
  {
    time: "",
    segments: [
      { type: "plain", text: "고철 부품 ×5 획득 — " },
      { type: "good",  text: "유물 복원 경험치 +12" },
    ],
  },
];
...
const INITIAL_LOGS: LogEntry[] = [
  ...
  },
  {
    time: "17:21",
    segments: [
      { type: "plain",     text: "순환_기공사_렌 에게 " },
      { type: "highlight", text: "정화수 ×1" },
      { type: "plain",     text: " 수령 — " },
      { type: "good",      text: "마나 피폭 -8%" },
    ],
  },
];
      ...
      <div className="content-body">
        ...
        <div className="activity-card">
          ...
          <div className="activity-meta">
            ...
            <div className="meta-item meta-next">▶ 다음 아이템 <span className="meta-val">&nbsp;&nbsp;{fmtCountdown(countdown)}</span></div>
          </div>
        </div>
