...
const ZONE_DATA = [
  ...
  // ── Branch: 키르타스 평원 ──────────────────────────────────────────────────
  {
    ...
    name: "키르타스 평원", levelReq: 0, dangerLevel: "보통",
  ...
  // ── Branch: 붉은 협곡 ─────────────────────────────────────────────────────
  {
    ...
    name: "붉은 협곡", levelReq: 0, dangerLevel: "위험",
  ...
  // ── Branch: 회색 고원 ─────────────────────────────────────────────────────
  {
    ...
    name: "회색 고원", levelReq: 0, dangerLevel: "위험",
  ...
  // ── Branch: 파이널 시티 외곽 ──────────────────────────────────────────────
  {
    ...
    name: "파이널 시티 외곽", levelReq: 0, dangerLevel: "극한",
